...
@section('title', 'Add FAQ - Creavibe')
...
<div class="max-w-2xl mx-auto">
    <div class="bg-white dark:bg-gray-800 shadow-sm rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
        <form action="{{ route('blog-admin.faqs.store') }}" method="POST" class="p-6 space-y-6" x-data="{ category: @js(old('category', 'general')), stats: @js($categoryStats) }">
            @csrf
            ...
            <div>
                ...
                <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                    <span x-text="stats[category]?.count ?? 0"></span> FAQs already exist in this category.
