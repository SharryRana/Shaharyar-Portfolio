...
@push('styles')
    <style>
        ...
        .icon-preview { width: 88px; height: 88px; border-radius: 18px; display: inline-flex; align-items: center; justify-content: center; background: rgba(67, 97, 238, .1); color: var(--primary); font-size: 2rem; }
            ...
            <div class="row g-4">
                <div class="col-lg-8">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            <label class="form-label">Tech / Category Label</label>
                            <input type="text" name="label" class="form-control @error('label') is-invalid @enderror" value="{{ old('label', $item->label) }}" placeholder="Backend">
                ...
                <div class="col-lg-4">
                    <div class="border rounded-4 p-3 h-100">
                        <div class="text-center mb-3">
                            <span class="icon-preview"><i id="iconPreview" class="{{ old('icon', $item->icon ?: 'fas fa-code') }}"></i></span>
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Icon Class</label>
                            <input id="iconInput" type="text" name="icon" class="form-control @error('icon') is-invalid @enderror" value="{{ old('icon', $item->icon) }}" placeholder="fas fa-code">
                            <div class="form-text">Use Font Awesome classes, for example: fas fa-database.</div>
...
@push('scripts')
    <script>
        document.getElementById('iconInput')?.addEventListener('input', function () {
            document.getElementById('iconPreview').className = this.value || 'fas fa-code';
        });
    </script>
@endpush
